...
<title>Pendidikan Kewarganegaraan</title>
		<body>
			<form class="form-horizontal" method="post" action="logincode.php">
				...
				<h5 align="center">Berisi daftar buku Pendidikan Kewarganegaraan yang siap dibeli</h5>
				</div>
<?php
	include 'connect.php';
	$sql=mysql_query("select * from buku where kelas = 1 and tingkatan='SMA' and mata_pelajaran='kwn'");
?>
