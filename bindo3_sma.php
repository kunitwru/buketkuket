...
<title>Bahasa Indonesia</title>
		<body>
			<form class="form-horizontal" method="post" action="logincode.php">
				...
				<h5 align="center">Berisi daftar buku Bahasa Indonesia yang siap dibeli</h5>
				</div>
<?php
	include 'connect.php';
	$sql=mysql_query("select * from buku where kelas = 1 and tingkatan='SMP' and mata_pelajaran='bahasa_indonesia'");
?>
...
<?php
	include 'connect.php';
	$sql=mysql_query("select * from buku where kelas = 3 and tingkatan='SMA' and mata_pelajaran='bahasa_indonesia'");
?>
	<p align="center">Daftar Buku</p>
